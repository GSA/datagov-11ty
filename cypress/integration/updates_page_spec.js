describe('The updates index page 1', () => {
    ...
    describe('pagination', () => {
        ...
        it('has three page number links', () => {
            paginationNav.find('li.usa-pagination__page-no').should('have.length', 3);
        });

        it('has a link to the second page', () => {
            paginationNav.find('li.usa-pagination__page-no a').contains('2');
        });
...
describe('The updates index page 2', () => {
    ...
    describe('pagination', () => {
        ...
        it('has four page number links', () => {
            paginationNav.find('li.usa-pagination__page-no').should('have.length', 4);
        });

        it('has a link to the third page', () => {
            paginationNav.find('li.usa-pagination__page-no a').contains('3');
        });
